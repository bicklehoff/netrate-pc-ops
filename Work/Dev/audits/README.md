...
**Last updated:** 2026-04-24 (v1.20 — D9e Phase 1 complete. `loan_borrowers` retired across schema + code + table drop, PRs #180–#190. See §11 change log.)
...
34. **D6 Core NonQM LLPA parser** — Everstream DSCR Plus + Expanded Prime Plus core tier adjustments explicitly skipped in `everstream-llpas.js:18-19` ("NOT handled here — follow-up PR"). Tracked under D6 but not blocking D6 completion. `nonqm_adjustment_rules` table already live from vocab PR #129; this is parser-only.
