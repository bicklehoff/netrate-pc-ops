...
echo "=============================================="
echo ""
echo "You MUST run get_briefing(device='pc', department='dev') and check_relay(device='pc') before responding to David."
echo ""

# --- REGISTRY (what's been built) ---
REGISTRY="$(dirname "$0")/../../REGISTRY.md"
if [ -f "$REGISTRY" ]; then
...
SESSION_LOG="$(dirname "$0")/../../../../SESSION-LOG.md"
...
echo "  1. get_briefing(device='pc', department='dev')"
