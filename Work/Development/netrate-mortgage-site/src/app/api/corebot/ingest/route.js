...
async function processLoan(loanData) {
  ...
  const loanFields = {
    ...
    ldoxLoanId,
    loanNumber,
    loanAmount: loanData.loanAmount || null,
    interestRate: loanData.noteRate || null,
    loanTerm: loanData.term || null,
    ...
    purchasePrice: loanData.purchasePrice || null,
    estimatedValue: loanData.appraisalValue || null,
    numUnits: loanData.units || null,
    ...
    creditScore: loanData.creditScore || null,
  };
