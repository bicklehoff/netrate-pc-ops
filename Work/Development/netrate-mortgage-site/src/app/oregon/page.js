...
export default function Oregon() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <p className="text-lg text-gray-500 mb-10">Licensed in Oregon. Same Low Rates.</p>

      <div className="space-y-8 text-gray-700 leading-relaxed">
        <section>
          <p>
            NetRate Mortgage is licensed to originate loans in Oregon. Our rates are the same whether you&apos;re in Boulder or Portland — because wholesale pricing doesn&apos;t change by state.
          </p>
