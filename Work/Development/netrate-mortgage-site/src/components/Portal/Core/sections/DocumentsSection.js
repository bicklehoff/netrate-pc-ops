// DocumentsSection — Documents list + request form + DocWorkspace + Payroll
// DocWorkspace replaces the old WorkDrivePanel + separate CoreBot card.
...
export default function DocumentsSection({ loan, onRefresh }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ─── DocWorkspace (CoreBot + File Browser) ─── */}
      <DocWorkspace loanId={loan.id} onRefresh={onRefresh} />
