...
export async function POST(request) {
  try {
    ...
    // Fetch participants for co-borrower context (post-D9e: reads
    // loan_participants junction instead of the retiring loan_borrowers
    // snapshot table). role aliased AS borrower_type for caller compat.
