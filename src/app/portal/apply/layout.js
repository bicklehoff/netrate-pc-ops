...
function SaveExitButton() {
  ...
  return saving ? (
    ...
    <button
      ...
      className="text-xs text-ink-subtle hover:text-ink-mid transition-colors"
    >
      Save &amp; Exit
    </button>
  );
...
export default function ApplyLayout({ children }) {
  return (
    <ApplicationProvider>
      ...
      <div id="apply-scroll-container" className="fixed inset-0 z-[60] bg-surface-alt flex flex-col overflow-auto">
        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shrink-0">
          <div className="max-w-3xl mx-auto px-6 py-3.5 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-0.5">
              ...
              <span className="text-sm font-normal text-ink-subtle ml-1.5">Mortgage</span>
            </Link>
            <div className="flex items-center gap-4">
              <span className="hidden sm:inline-flex items-center gap-1.5 text-[11px] text-ink-subtle font-medium">
        ...
        <footer className="border-t border-gray-100 shrink-0">
          <div className="max-w-3xl mx-auto px-6 py-4 text-center text-[11px] text-ink-subtle">
