...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.netratemortgage.com/reverse-mortgage',
  },
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <nav className="text-sm text-gray-400 mb-8">
        ...
        <span className="text-gray-600">Reverse Mortgage</span>
      </nav>
      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Forget What You&apos;ve Seen on TV</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">The Income Advantage Nobody Talks About</h2>
          <p>
          ...
          <p className="mt-4">This opens the door for homeowners who:</p>
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>Are retired and living on a fixed income</li>
            <li>Are self-employed with complicated tax returns</li>
            <li>Have high equity but low documented income</li>
            <li>Couldn&apos;t qualify for a traditional refinance or cash-out</li>
          </ul>
          <p className="mt-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Five Ways to Use a Reverse Mortgage</h2>
          <p>
            A reverse mortgage isn&apos;t one product — it&apos;s a flexible tool with multiple use cases. Here&apos;s how people actually use them:
          </p>

          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">1. Eliminate Your Monthly Payment</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">2. Set Up a Line of Credit (Rainy Day Fund)</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">4. Access Cash from Your Equity</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-2">5. Do Nothing Now — Have It Ready Later</h3>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">What You Still Have to Pay</h2>
          <p>
            A reverse mortgage eliminates your monthly mortgage payment. It does not eliminate:
          </p>
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li><strong>Property taxes</strong> — still your responsibility</li>
            <li><strong>Homeowners insurance</strong> — still required</li>
            <li><strong>HOA fees</strong> — if applicable</li>
            <li><strong>Home maintenance</strong> — the property must be maintained</li>
          </ul>
          <p className="mt-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">How It Works (The Basics)</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>You must be 62 or older (at least one borrower)</li>
            <li>The home must be your primary residence</li>
            <li>HUD-approved counseling is required before closing (for HECMs)</li>
            <li>The loan is repaid when you sell, move out, or pass away</li>
            <li>Your heirs can sell the home and keep any remaining equity, or refinance into a traditional loan</li>
            <li>If the home is worth less than the loan balance, FHA insurance covers the difference — your heirs are never responsible for the shortfall (this is called the &ldquo;non-recourse&rdquo; feature)</li>
          </ul>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">&ldquo;Will the Bank Take My Home?&rdquo;</h2>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>Sell the home and keep any equity above the loan balance</li>
            <li>Refinance the reverse mortgage into a traditional loan and keep the home</li>
            <li>Walk away — if the home is underwater, FHA insurance covers the lender. Your heirs owe nothing.</li>
          </ul>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Is a Reverse Mortgage Right for You?</h2>
          <p>It depends on your situation. A reverse mortgage makes sense if:</p>
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>You have significant home equity and need to reduce monthly expenses</li>
            <li>Your income doesn&apos;t support a traditional mortgage qualification</li>
            <li>You want access to cash without selling your home</li>
            <li>You&apos;re planning to age in place</li>
            <li>You want a financial safety net that grows over time</li>
          </ul>
          <p className="mt-4">It may not make sense if:</p>
          <ul className="list-disc pl-6 space-y-2 mt-2">
            <li>You plan to move in the near future</li>
            <li>You want to leave the home to heirs with no mortgage attached</li>
            <li>You can qualify for a traditional refinance at a lower cost</li>
          </ul>
          <p className="mt-4">
        ...
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Why NetRate for Reverse Mortgages?</h2>
          <p>
        ...
        <div className="pt-4">
          <Link href="/contact" className="inline-block bg-brand text-white px-6 py-3 rounded-lg font-semibold hover:bg-brand-dark transition-colors">
            Contact Us &rarr;
          </Link>
        </div>
