...
export const metadata = {
  ...
  alternates: { canonical: 'https://www.netratemortgage.com/texas' },
};
...
export default function Texas() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <p className="text-lg text-gray-500 mb-10">Licensed in Texas.</p>
      ...
      <div className="space-y-8 text-gray-700 leading-relaxed">
        <section>
          ...
          <p className="mt-4">A few things that vary in Texas specifically:</p>
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-4">
            <li>
              <strong>See the rates</strong> — <Link href="/rates?state=TX" className="text-brand hover:text-brand-dark font-medium">Check today&apos;s Texas rates</Link>. No application, no credit pull.
            </li>
            <li>
