...
// Fallback new-rate if homepage_rate_cache read returns null at SSR.
// Current rate intentionally stays hardcoded — it's the borrower's
// existing note rate, which they override to match their own loan.
...
export default function CostOfWaitingClient({ parRate }) {
  return <Suspense><CostOfWaitingContent parRate={parRate} /></Suspense>;
}
