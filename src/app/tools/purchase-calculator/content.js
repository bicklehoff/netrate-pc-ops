...
// Fallback rate if the homepage_rate_cache read returns null at SSR.
// This is a rough out-of-date value, only reached if the DB cache is
// empty — the cache reader is best-effort.
...
export default function PurchaseCalculatorClient({ parRate }) {
  return <Suspense><PurchaseCalculatorContent parRate={parRate} /></Suspense>;
}
