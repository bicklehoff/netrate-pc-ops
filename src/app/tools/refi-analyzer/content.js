...
// existing note rate, which they override based on their own loan.
...
export default function RefiAnalyzerClient({ parRate }) {
  return <Suspense><RefiAnalyzerContent parRate={parRate} /></Suspense>;
}
