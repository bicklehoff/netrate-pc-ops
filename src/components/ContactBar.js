...
export default function ContactBar() {
  ...
  return (
    <div className="bg-brand/10 border-b border-brand/20 text-sm">
      <div className="max-w-6xl mx-auto px-4 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 sm:gap-5">
          ...
          <a
            ...
            className="flex items-center gap-2 text-gray-700 hover:text-brand transition-colors px-2 py-0.5 font-medium"
          >
