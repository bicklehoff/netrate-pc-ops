// MloNav — Left sidebar navigation for all MLO portal pages.
// Slim vertical bar with icons + labels, active page highlighted.
...
const NAV_ITEMS = [
  ...
  {
    href: '/portal/mlo/messages',
    label: 'Comms',
    match: (p) => p.startsWith('/portal/mlo/messages'),
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: '/portal/mlo/scenario-alerts',
    label: 'Alerts',
    match: (p) => p.startsWith('/portal/mlo/scenario-alerts'),
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: '/portal/mlo/quotes',
    label: 'Quotes',
    match: (p) => p.startsWith('/portal/mlo/quotes') || p.startsWith('/portal/mlo/tools/quote'),
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function MloNav() {
  ...
  return (
    <nav className="w-14 md:w-48 transition-all duration-200 bg-gray-900 border-r border-gray-800 flex flex-col h-full flex-shrink-0 overflow-hidden group">
      {/* Nav items */}
