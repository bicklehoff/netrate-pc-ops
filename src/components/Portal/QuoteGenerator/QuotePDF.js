...
const s = StyleSheet.create({
  ...
  valCell: { width: '20%', paddingVertical: 5, paddingHorizontal: 8, textAlign: 'right', fontSize: 10, fontFamily: 'Helvetica-Bold' },
  valCellBold: { width: '20%', paddingVertical: 5, paddingHorizontal: 8, textAlign: 'right', fontSize: 10.5, fontFamily: 'Helvetica-Bold' },
  ...
  feeAmount: { fontSize: 9.5, fontFamily: 'Helvetica-Bold' },
