    ...
    <div className="bg-white border border-gray-200 rounded-lg my-4 overflow-hidden">
      ...
      {compareRates.length === 0 && (
        <div className="px-5 py-3 border-b border-gray-100 flex items-center justify-between print:hidden">
          <p className="text-sm text-gray-500 hidden sm:block">Save this scenario to track rate changes over time.</p>
          <button
            onClick={() => onSaveScenario?.()}
            className="bg-brand text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:bg-brand-dark transition-colors whitespace-nowrap flex items-center gap-2 ml-auto"
          >
