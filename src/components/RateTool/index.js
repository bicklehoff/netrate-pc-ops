...
export default function RateTool({ initialRateData, defaultState, prefill, brpToken }) {
  ...
  const [scenario, setScenario] = useState({
    purpose: prefill?.purpose || DEFAULT_SCENARIO.loan_purpose,
    loan_type: prefill?.loan_type || 'conventional',
    property_type: prefill?.property_type || DEFAULT_SCENARIO.property_type,
    property_value: prefill?.property_value || DEFAULT_SCENARIO.property_value,
