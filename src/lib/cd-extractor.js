...

{
  ...
  "appraisalReimb": "<number — appraisal fee from Section B marked POC (Paid Outside Closing) by borrower, reimbursed through broker wire>",
  "creditReimb": "<number — credit report fee from Section B marked POC, reimbursed through broker wire>",
  "miscReimb": "<number — any other POC items in Section B or H reimbursed through broker wire>",
